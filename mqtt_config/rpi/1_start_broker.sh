...
sudo chmod -R 777 /data/elastic_network_of_things_with_mqtt_and_micropython/mqtt_config/rpi/mqtt/*

docker run -d -p 1883:1883 -p 9001:9001 --name=Mosquitto --hostname=Mosquitto \
--volume=/data/elastic_network_of_things_with_mqtt_and_micropython/mqtt_config/rpi/mqtt/config:/mqtt/config:ro \
--volume=/data/elastic_network_of_things_with_mqtt_and_micropython/mqtt_config/rpi/mqtt/data:/mqtt/data \
--volume=/data/elastic_network_of_things_with_mqtt_and_micropython/mqtt_config/rpi/mqtt/log:/mqtt/log \
